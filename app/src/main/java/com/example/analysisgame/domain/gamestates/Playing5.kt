...
class Playing5(val game: Game, val context: Context, gameLoop: GameLoop) : BaseState(game), GameStateInterface {

    val tilemap = Tilemap(SpriteSheet(context, R.drawable.adv_game_tiles), 5)
