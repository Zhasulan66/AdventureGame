...
class GameOverView(context: Context,  private val game: Game) : View(context) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // Game Over text
        canvas.drawText("Game Over", GAME_WIDTH / 2f, 250f, textPaint)
        ...
        canvas.drawText("Retry", retryRect.centerX(), retryRect.centerY() + 20f, buttonTextPaint)
    }
